...
<div className="max-w-xs rounded-lg shadow-lg dark:bg-gray-900 dark:text-gray-100">
	<div className="flex items-end justify-end h-32 p-4 dark:bg-gray-500 bg-center bg-cover">
		<p className="px-2 py-1 text-sm tracki dark:text-gray-100 uppercase dark:bg-gray-800 bg-opacity-75 rounded shadow-lg">Miami</p>
	</div>
